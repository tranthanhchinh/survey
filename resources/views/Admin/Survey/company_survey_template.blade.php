@extends('master')
@section('content')
    <div class="modal fade preview-survey" id="preview-survey" tabindex="-1" role="dialog" aria-labelledby="preview-survey" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body show-result-privew">
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Chọn mẫu khảo sát để bắt đầu</h1>
                        ...
                        <div class="row no-gutters align-items-center survey-box-content">
                            ...
                            <div class="col mr-2">
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <h2>{{ $list->name }}</h2>
                                    <div class="des-survey">{{ Str::words($list->description, 20) }}</div>
                                    <div class="act-survey">
                                        <span data-id="{{ $list->id }}" class="btn-tp-click-convert">Sử dụng mẫu này</span>
                                       <span class="btn-tp-click" data-toggle="modal" data-target="#preview-survey" data-id="{{ $list->id }}">Xem trước khảo sát</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
