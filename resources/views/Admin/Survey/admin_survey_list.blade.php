...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Kho khảo sát mẫu</h1>
            <a class="d-none d-sm-inline-block btn btn-lg btn-primary shadow-sm btn-addnew" data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-calendar-plus"></i> <span>Tạo khảo sát mới</span></a>
        </div>

        <!-- Content Row -->
        <div class="row">
            @include('Admin.Survey.admin_survey_add')
            <div class="modal fade" id="popupShowDetail" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            ...
                            <div class="col-auto survey-setting-icon  dropdown no-arrow">
                                ...
                                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown2">
                                    <a class="dropdown-item d-flex align-items-center " data-toggle="modal" data-target="#popupShowDetail">
                                        ...
                                        <div><span class="font-weight-bold admin_click_survey" data-id="" data-toggle="modal" data-target="#popupShowDetail">Chỉnh sửa khảo sát</span></div>
                                    </a>
                                    <a class="dropdown-item d-flex align-items-center">
                                        ...
                                        <div><span class="font-weight-bold btn_paused_survey" data-id="" >Xóa khảo sát</span></div>
                                    </a>
